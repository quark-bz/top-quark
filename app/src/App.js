    ...
    return(
        <Router>
            ...
            <Container id="aboutPageContainer">
                    ...
                    twoItem={
                        <div class="aboutimage" id="imageStudent"></div>
                    }
                    />
                    ...
                    oneItem={
                        <div class="aboutimage" id="imageToolsMan"></div>
                    }
                    />
                  ...
                  class='aboutpagestuff'
                    ...
                    oneItem={
                        ...
                        twoItem={
                            <div class="aboutimage" id="imageFeedback"></div>
                        }
                    />
                      <TwoItemSubIcon 
                      id='abouttextfour'
                    ...
                    twoItem={
                        ...
                        oneItem={
                            <div class="aboutimage"  id="imageDeveloper"></div>
                        }
                    />
